...
def get_dashboard_stats(db: Session, user_id: int):
    # 1. Filter games where the user was either White or Black
    ...
    # 2. Logic to determine Wins/Losses based on WHITE_WIN/BLACK_WIN
    wins = 0
    draws = 0
    if total_games > 0:
    ...
    # 3. Fetch Balance (Optimized: Get from User table, not by summing transactions)
    ...
    # 4. Recent games with proper opponent detection
